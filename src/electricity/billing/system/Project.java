...
public class Project extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (msg.equals("New Customer")) {
            ...
            try {
                Runtime.getRuntime().exec("notepad.exe"); //to get the software application from the system
            } catch (Exception e) {
                e.printStackTrace();
            }
        } else if (msg.equals("Calculator")) {
            try {
                Runtime.getRuntime().exec("calc.exe"); //the executable file name of calculator in system in named calc.exe
            } catch (Exception e) {
                e.printStackTrace();
            }
