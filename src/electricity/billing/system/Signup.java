...
public class Signup extends JFrame implements ActionListener{
    ...
    Signup(){
        ...
        meter.addFocusListener(new FocusListener() { //helps to recieve keyboard focus events on the components.
            @Override
        ...
        accountType.addItemListener(new ItemListener() { //focus on when item is selected or de-selected
            public void itemStateChanged(ItemEvent ae) {
                String user = accountType.getSelectedItem();
                if (user.equals("Customer")) {
                    lblmeter.setVisible(true);
                    meter.setVisible(true);
                    name.setEditable(false); //not editable for customers
                } else {
                    lblmeter.setVisible(false);
                    meter.setVisible(false);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == create) {
            ...
            try {
                ...
                } else {//update the username and password on table when customer account craeted
