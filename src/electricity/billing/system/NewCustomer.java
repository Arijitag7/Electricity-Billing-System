...
public class NewCustomer extends JFrame implements ActionListener {
    ...
    NewCustomer() {
        ...
        // Generating a 6-digit positive meter number
        Random ran = new Random();
        long number = Math.abs(ran.nextInt(900000) + 100000); // Ensures it's a 6-digit number
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == next) {
            ...
            String query1 = "INSERT INTO customer (name, meter_no, address, state, city, email, phone_number) VALUES ('"
                + name + "', '" + meter + "', '" + address + "', '" + state + "', '" + city + "', '"
                + email + "', '" + phone + "')";
